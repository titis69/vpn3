...
echo -e "□ AutoScript By       = Wak ${GREEN}( berlian )${NC}"
...
echo -e "${YELLOW}[02]${NC} • [${YELLOW}VMESS${NC}]    ${YELLOW}[09]${NC} • [${YELLOW}SET${NC}]"
echo -e "${YELLOW}[03]${NC} • [${YELLOW}VLESS${NC}]    ${YELLOW}[10]${NC} • [${YELLOW}INFORMATION${NC}]"
echo -e "${YELLOW}[04]${NC} • [${YELLOW}TROJAN${NC}]   ${YELLOW}[11]${NC} • [${YELLOW}ADD DOMAIN${NC}]"
echo -e "${YELLOW}[05]${NC} • [${YELLOW}SODOS${NC}]    ${YELLOW}[12]${NC} • [${YELLOW}CERT${NC}]"
echo -e "${YELLOW}[06]${NC} • [${YELLOW}SET DNS${NC}]  ${YELLOW}[13]${NC} • [${YELLOW}LOAD VPS${NC}]"
