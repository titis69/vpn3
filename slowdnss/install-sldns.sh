...
echo -e "[ ${green}INFO${NC} ] Successfully... "
sleep 1
#wget -q -O /etc/systemd/system/client-sldns.service "https://raw.githubusercontent.com/myridwan/multi-ws/ipuk/slowdnss/client-sldns.service"
#wget -q -O /etc/systemd/system/server-sldns.service "https://raw.githubusercontent.com/myridwan/multi-ws/ipuk/slowdnss/server-sldns.service"
cd
sleep 1
